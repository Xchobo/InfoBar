...
//    // 將訊息改至上方
//    [ZAActivityBar sharedView].offset = 20;
}
...
- (void) updateActionIndicator {
    ...
    [UIView animateWithDuration:(shouldAnimate ? 0.1f : 0.0f)
                          delay:0.0f
                        options:UIViewAnimationOptionCurveEaseInOut // Not required: |UIViewAnimationOptionBeginFromCurrentState
                     animations:^{
...
//        CGSize stringSize = [string sizeWithFont:self.stringLabel.font constrainedToSize:CGSizeMake(width, 300)];
//        float width = 30;
//        CGSize stringSize = [string boundingRectWithSize:CGSizeMake(width, 300)
